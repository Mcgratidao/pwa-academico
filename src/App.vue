Não está funcionando nada no site, aquela versão que te mandei tanto lógica como leiout estavam bom. <template>
...
Nessa versão estava tudo indo bem. Quero que organize aquelas coisas que eu te pedi.
